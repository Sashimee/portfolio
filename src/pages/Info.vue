<template>
  <q-page class="q-pa-md">
    ...
    <p>
      At this internet site, accessible from <a target="_blank" :class="$q.dark.isActive ? 'g_link_white' : 'g_link_black'" href="https://baskewitsch.lu">https://baskewitsch.lu</a>, one of our
      main priorities is the privacy of our visitors. This Privacy Policy
      document contains types of information that is collected and recorded by
      Alex Baskewitsch and how we use it.
    </p>
    ...
    <p>
      ...
      <a target="_blank" :class="$q.dark.isActive ? 'g_link_white' : 'g_link_black'" href="https://www.gdprprivacynotice.com/"
    ...
    <p>
      <a target="_blank" :class="$q.dark.isActive ? 'g_link_white' : 'g_link_black'" href="https://baskewitsch.lu">https://baskewitsch.lu</a> legal basis for collecting and using the personal
    ...
    <ul>
      <li><a target="_blank" :class="$q.dark.isActive ? 'g_link_white' : 'g_link_black'" href="https://baskewitsch.lu">https://baskewitsch.lu</a> needs to perform a contract with you</li>
      <li>You have given <a target="_blank" :class="$q.dark.isActive ? 'g_link_white' : 'g_link_black'" href="https://baskewitsch.lu">https://baskewitsch.lu</a> permission to do so</li>
      <li>
        Processing your personal information is in <a target="_blank" :class="$q.dark.isActive ? 'g_link_white' : 'g_link_black'" href="https://baskewitsch.lu">https://baskewitsch.lu</a>
        legitimate interests
      </li>
      <li><a target="_blank" :class="$q.dark.isActive ? 'g_link_white' : 'g_link_black'" href="https://baskewitsch.lu">https://baskewitsch.lu</a> needs to comply with the law</li>
    </ul>

    <p>
      <a target="_blank" :class="$q.dark.isActive ? 'g_link_white' : 'g_link_black'" href="https://baskewitsch.lu">https://baskewitsch.lu</a> will retain your personal information only for as
    ...
    <p>
      Alex Baskewitsch follows a standard procedure of using log files. These
    ...
    <p>
      Like any other website, Alex Baskewitsch uses 'cookies'. These cookies are
    ...
    <p>
      ...
      <a target="_blank" :class="$q.dark.isActive ? 'g_link_white' : 'g_link_black'" href="https://www.privacypolicyonline.com/what-are-cookies/"
        >"What Are Cookies"</a
      >.
    </p>
    ...
    <P
      ...
      advertising partners of Alex Baskewitsch.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Alex Baskewitsch, which are sent
    ...
    <p>
      Note that Alex Baskewitsch has no access to or control over these cookies
    ...
    <p>
      Alex Baskewitsch's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Alex Baskewitsch does not knowingly collect any Personal Identifiable
    ...
    <p>
      ...
      and/or collect in Alex Baskewitsch. This policy is not applicable to any
