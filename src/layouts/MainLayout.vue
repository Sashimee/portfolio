<template>
  <q-layout view="hHh lpR fFf">
                ...
                <q-card-section class="q-pt-none">
                  ...
                  <p>
                    ...
                    <a
                      target="_blank"
                      :class="
                        $q.dark.isActive ? 'g_link_white' : 'g_link_black'
                      "
                    ...
                    information that is collected and recorded by Alex
                    Baskewitsch and how we use it.
                  </p>
                  ...
                  <p>
                    ...
                    <a
                      ...
                      >GDPR Privacy Policy Generator from
                      GDPRPrivacyNotice.com</a
                    >
                  </p>
                  ...
                  <p>
                    Alex Baskewitsch follows a standard procedure of using log
                  ...
                  <p>
                    Like any other website, Alex Baskewitsch uses 'cookies'.
                  ...
                  <P
                    ...
                    each of the advertising partners of Alex Baskewitsch.</P
                  >

                  <p>
                    Third-party ad servers or ad networks uses technologies like
                    cookies, JavaScript, or Web Beacons that are used in their
                    respective advertisements and links that appear on Alex
                    Baskewitsch, which are sent directly to users' browser. They
                  ...
                  <p>
                    Note that Alex Baskewitsch has no access to or control over
                  ...
                  <p>
                    ...
                    information that they shared and/or collect in Alex
                    Baskewitsch. This policy is not applicable to any
    ...
    <q-footer class="bg-primary text-white">
      ...
      <q-toolbar>
        <q-toolbar-title
          ><q-btn flat to="/info" size="sm">Legal info</q-btn></q-toolbar-title
        >
